...
function renderProductCard(product) {
    ...
    return `
        <div class="product-card">
            ...
            <p>até ${product.installments}x de R$ ${installmentPrice} sem juros</p>
...
function renderCartPage() {
    ...
    if (cart.length === 0) {
        document.querySelector(".cart-container").innerHTML = "<h1 class='section-title'>Seu carrinho está vazio.</h1><p style='text-align:center;'><a href='produtos.html' class='btn'>Ver produtos</a></p>";
        return;
    }
